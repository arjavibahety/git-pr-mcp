...
from webhook_server import EVENTS_FILE
...
async def get_workflow_status(workflow_name: Optional[str] = None) -> str:
    ...
    # 3. If return json.dumps({"message": "No Github actions events received yet"})return json.dumps({"message": "No Github actions events received yet"}) provided, filter by that name
